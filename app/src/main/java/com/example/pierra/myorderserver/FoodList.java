...
import com.example.pierra.myorderserver.Model.Category;
import com.example.pierra.myorderserver.Model.Food;
import com.example.pierra.myorderserver.ViewHolder.FoodViewHolder;
...
import static com.example.pierra.myorderserver.Common.Common.PICK_IMAGE_REQUEST;
import static com.example.pierra.myorderserver.R.id.fab;
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (newFood != null) {
                    ...
                    Snackbar.make(rootLayout, "Category" + newFood.getName() + "was edited", Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
